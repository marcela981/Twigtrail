...
export const useFollowCam = function (props: UseFollowCamProps) {
  ...
  let smallestDistance: number = 0.5;
  let cameraDistance: number = 0;
  ...
  const onTouchMove = (e: TouchEvent) => {
    ...
    if (previousTouch1 && touch1 && !touch2) {
    ...
    if (previousTouch1 && previousTouch2 && touch1 && touch2) {
  ...
  const cameraCollisionDetect = (delta: number) => {
    ...
    const intersects = camRayCast.intersectObjects(intersectObjects);
